...
func (w *Window) PreferredSize(self Widget, ctx *vg.Context) (int, int) {
	if w.buttonPanel != nil {
...
func (w *Window) OnPerformLayout(self Widget, ctx *vg.Context) {
	if w.buttonPanel == nil {
...
func (w *Window) Draw(self Widget, ctx *vg.Context) {
	...
	if w.title != "" {
		headerPaint := vg.LinearGradient(wx, wy, ww, wh+hh, w.theme.WindowHeaderGradientTop, w.theme.WindowHeaderGradientBot)
